...
test-pearsonr-sqr-raw-4K-prep: test/sample_bs_input.starch test/sample_bs_input.bed test-sample-performance-prep
#	sample -k 5000 --preserve-order test/sample_bs_input.bed > $(SAMPLEDIR)/vec_test5K.bed
