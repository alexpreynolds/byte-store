...
set temp=(`getopt -s tcsh -o hmxujtgdMw:o: --long help,mutual-regions,xfac2015,uniprobe,jaspar,taipale,hg38-jaccard,hg38-dnaseI,mm10-dnaseI,within-range:,outside-range: -- $argv:q`)
if ($? != 0) then
